...
export default function ThemeToggleButton({
  ...
  return (
    ...
    >
      <SunIcon className='size-[1.2rem] rotate-0 scale-100 transition-all duration-700 dark:-rotate-[720deg] dark:scale-0' />
      <MoonIcon className='absolute size-[1.2rem] rotate-0 scale-0 transition-all duration-700 dark:rotate-[720deg] dark:scale-100' />
